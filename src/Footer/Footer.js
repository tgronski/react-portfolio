...
import { faTwitter, faLinkedinIn, faGithub, faDev, faCodepen } from '@fortawesome/free-brands-svg-icons'
import './Footer.css'
    ...
    <footer>
       <section className="corner" >
            <ul className="socialIcons">
                ...
                <li className="social"><a href="https://codepen.io/tcgronk" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faCodepen}/></a></li>      
